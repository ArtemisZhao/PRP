...
pval1 = sapply(1:p, function(x) prior_prp(beta = beta[x,], se = se[x,],test="pub_bias")$pvalue)
pval2 = sapply(1:p, function(x) prior_prp(beta = beta[x,], se = se[x,],test="two_sided")$pvalue)
