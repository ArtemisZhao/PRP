...
#pval_censor.labs <- c("no censoring", "censoring at p=0.05", "censoring at p=0.01")
#names(pval_censor.labs) <- c('no censor','0.05','0.01')

#test_statistics.labs<-c("default test statistic","beta[1]")
#names(test_statistics.labs)<-c("default","pub_bias")
